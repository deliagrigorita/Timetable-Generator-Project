...
from Timetable.schedule_monitor import check_overlapping_schedule, handle_overlapping_schedule
...
def add_schedule(request):
    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if not check_overlapping_schedule(new_schedule):
                new_schedule.save()
                return redirect('index')
            else:
                handle_overlapping_schedule(new_schedule)
                return redirect('index')
